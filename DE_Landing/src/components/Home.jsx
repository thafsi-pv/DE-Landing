      ...
      <main>
        <div
          ...
          <div className="absolute top-0 w-full h-full">
            ...
            <div
              id="blackOverlay"
              className="w-full h-full absolute top-0 opacity-75 bg-black"></div>
          </div>
              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  ...
                  <p className="mt-4 text-lg text-gray-300">
                    ...
                    efficiency and customer satisfaction with DineEase-POS"
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-gray-600">
                      Users can securely sign in to their accounts or create new
                      ones to access the POS system. Multi-factor authentication
                      and password encryption ensure data protection.
                    </p>
                  </div>
                </div>
              </div>
